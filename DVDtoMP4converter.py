...
# NOTE: The HandBrake settings used in this command have not been reviewed by anyone from AV Pres, I just picked them
# out best I could as a "good enough" selection for the task at hand.
...
for item_level_dir in os.listdir(working_dir):
    ...
    if len(found_content_dirs) == 0:
        log = open("HandBrakeConversion.log", 'a')
